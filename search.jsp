...
String name = (String)request.getSession().getAttribute("name");
    ...
    while(rs.next()){
    z=1;
    	session.setAttribute("pro_name",rs.getString(1) ); 
    	session.setAttribute("cat",rs.getString(2) );
    	session.setAttribute("price",rs.getString(3) );
    	session.setAttribute("active",rs.getString(4) );%>
...
<td><a href="addcart.jsp" ><input type=submit></a></td>
</tr>
<%
    }}catch(Exception e){
